...
export default function Skills() {
  return (
    <section id="skills" className="py-24 px-6 max-w-6xl mx-auto border-t border-zinc-200 dark:border-zinc-800">
      ...
      {/* Section Header - Aligned with Projects.tsx */}
      <motion.div
        ...
        {skills.map((skill, index) => (
          <motion.div
            ...
            transition={{ 
              duration: 0.5, 
              delay: index * 0.05,
              type: "spring", // Added Spring physics for a premium feel
              bounce: 0.3 
            }}
          ...
          >
            ...
            {/* The SVG Icon: Grayscale default, full color on hover */}
            <div className="relative w-8 h-8 md:w-10 md:h-10 opacity-70 group-hover:opacity-100 grayscale group-hover:grayscale-0 transition-all duration-300">
              <img 
                src={skill.image} 
                alt={skill.name} 
            ...
            {/* The Skill Name */}
            <span className="font-semibold text-sm md:text-base text-zinc-600 dark:text-zinc-400 group-hover:text-zinc-900 dark:group-hover:text-zinc-50 transition-colors duration-300">
              {skill.name}
            </span>
